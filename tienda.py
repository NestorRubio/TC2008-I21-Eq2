...
empleadoDisponible = threading.Semaphore(0) #revisa si el empleado está disponible - boolean
lugarDisponible = threading.Semaphore(1) #revisa si hay lugares y que solo un cliente entre
clientes = threading.Semaphore(0) #indica si el cliente ya puede ser atendido
